      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="pt-16 pb-24">
          <div className="text-center">
            ...
            <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
              ...
              <span className="block text-indigo-400">for Decentralized</span>
            </h1>
        ...
        <div className="py-12">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-2">
            ...
            <div className="p-6 bg-[#2a2155] rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-indigo-400 text-2xl mb-4">💎</div>
              <h3 className="text-lg font-semibold mb-2 text-white">Crypto Payments</h3>
            ...
            <div className="p-6 bg-[#2a2155] rounded-xl shadow-sm hover:shadow-md transition-shadow">
              <div className="text-indigo-400 text-2xl mb-4">🌐</div>
              <h3 className="text-lg font-semibold mb-2 text-white">Global Marketplace</h3>
              <p className="text-gray-300">
