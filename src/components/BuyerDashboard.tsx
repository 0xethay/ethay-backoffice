...
export default function BuyerDashboard() {
  ...
  const orders: Order[] = [
    { id: '1', productName: 'Wireless Headphones', status: 'waiting', date: '2023-05-01' },
    { id: '2', productName: 'Smart Watch', status: 'shipping', date: '2023-05-05' },
    { id: '3', productName: 'Laptop', status: 'history', date: '2023-04-20' },
    { id: '4', productName: 'Smartphone', status: 'waiting', date: '2023-05-10' },
    { id: '5', productName: 'Tablet', status: 'shipping', date: '2023-05-08' },
    { id: '6', productName: 'Gaming Console', status: 'history', date: '2023-04-15' },
  ]
