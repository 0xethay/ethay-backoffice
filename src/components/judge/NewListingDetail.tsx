...
export const NewListingDetail: React.FC<NewListingDetailProps> = ({
  task,
  onBack,
}) => {
  ...
  const handleSubmit = () => {
    console.log('Submitted:', {
      attestationAmount: attestationAmount[0],
      reason,
    });
  ...
  return (
    <div>
      ...
      <div className='grid grid-cols-2 gap-4'>
        <p>
          <span className='font-medium'>Contract:</span> {task.contractAddress}
        </p>
        <p>
          <span className='font-medium'>Amount:</span> {task.amount}
        </p>
        <p>
          <span className='font-medium'>Freelancer:</span> {task.freelancer}
        </p>
        <p>
