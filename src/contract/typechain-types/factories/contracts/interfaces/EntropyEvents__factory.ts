...
} from "../../../contracts/interfaces/EntropyEvents";
...
export class EntropyEvents__factory {
  ...
  static createInterface(): EntropyEventsInterface {
    return new Interface(_abi) as EntropyEventsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): EntropyEvents {
    return new Contract(address, _abi, runner) as unknown as EntropyEvents;
  }
}
