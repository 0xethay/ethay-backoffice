...
import type {
  IEntropy,
  IEntropyInterface,
} from "../../../contracts/interfaces/IEntropy";
...
export class IEntropy__factory {
  ...
  static createInterface(): IEntropyInterface {
    return new Interface(_abi) as IEntropyInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IEntropy {
    return new Contract(address, _abi, runner) as unknown as IEntropy;
  }
}
